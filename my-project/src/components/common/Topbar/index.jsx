  ...
  return (
    <div className="h-[55px] flex items-center border-b-[1px] border-gray-200 mx-auto md:ml-20 ">
      ...
      <div className="flex items-center p-3 h-full mx-auto ">
        <div className="cursor-pointer lg:hidden flex flex-col items-center justify-center xs:ml-7 vs:ml-0 xxs:ml-5 text-gray-500 hover:text-gray-900">

          <IoSearchSharp className="sm:w-8 sm:h-6 h-[30px] w-[25px]" />

          <p className="text-xs mt-0 hidden sm:flex">Search</p>
        </div>
        <Link to="/home" className=" flex flex-col items-center justify-center xs:ml-7 vs:ml-4 xxs:ml-5 text-gray-500 hover:text-gray-900">
